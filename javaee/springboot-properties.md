...
在 spring boot 项目里面,有一些参数需要自己配置,那么找到这些参数叫什么名字,该配置什么,无疑是一件很重要的事情.

在 spring 的官方文档里面[Spring boot2.0 官方文档](https://docs.spring.io/spring-boot/docs/2.0.0.RELEASE/reference/htmlsingle/)的`Common application properties`章节就有配置项说明.
